...
export default class Island extends Component<P, S> {
  ...
  componentDidUpdate(previousProps: Readonly<P>, previousState: Readonly<S>, snapshot: Any) {
    console.log(7, 'componentDidUpdate', previousProps, previousState, snapshot);
  }
